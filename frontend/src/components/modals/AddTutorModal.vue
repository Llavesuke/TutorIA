...
.enhanced-loading-screen {
  ...
  // Custom scrollbar for loading screen
  &::-webkit-scrollbar {
    width: 6px;
  }
  ...
  &::-webkit-scrollbar-thumb {
    background: rgba(230, 83, 29, 0.5);
    border-radius: 3px;

    &:hover {
      background: rgba(230, 83, 29, 0.7);
    }
  }
}
...
.loading-spinner {
  width: 50px;
  height: 50px;
  border: 3px solid rgba(230, 83, 29, 0.2);
  border-top: 3px solid #e6531d;
  border-radius: 50%;
  animation: spin 1s linear infinite;
  margin: 0;
  box-shadow: 0 0 20px rgba(230, 83, 29, 0.3);
}
